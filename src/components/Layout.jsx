      ...
      <div className="container">
        <nav className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <Link
              to="/contact"
              className="ml-4 px-5 py-2 bg-primary text-primary-foreground text-sm font-display uppercase tracking-wide rounded-lg hover:bg-primary/90 transition-colors"
            >
              Get Started
            </Link>
          </div>
