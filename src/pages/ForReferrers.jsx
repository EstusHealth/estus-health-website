...
// ─── STYLES (SAGE & CLAY THEME) ──────────────────────────────────────────────
const S = {
  page: {
    minHeight: "100vh",
    background: "hsl(40 15% 97%)", // Clean Almond
    backgroundImage: "linear-gradient(180deg, hsl(40 15% 98%) 0%, hsl(40 15% 96%) 100%)",
    color: "hsl(30 10% 15%)", // Charcoal Earth
  ...
  accentGradient: {
    background: "linear-gradient(135deg, hsl(24 85% 50%), hsl(35 90% 55%))",
  ...
  // ── Self-referral callout (Using Sage Green for contrast) ────────────────
  callout: {
    background: "hsl(0 0% 100%)",
    border: "1px solid hsl(140 25% 60% / 0.3)", // Sage border
    borderRadius: "6px",
    boxShadow: "0 4px 20px hsl(140 25% 60% / 0.15)", // Sage glow
  ...
  calloutBar: {
    width: "4px",
    background: "hsl(140 30% 45%)", // Deeper Sage
    borderRadius: "2px",
    flexShrink: 0,
  },
  calloutInner: {
  ...
  card: {
    ...
    borderRadius: "6px",
    boxShadow: "0 4px 12px -2px rgba(30, 20, 10, 0.06)",
  ...
  ctaBtn: {
    ...
    boxShadow: "0 4px 14px hsl(24 85% 50% / 0.25)",
  },
  ctaNote: {
    fontSize: "0.75rem",
    color: "hsl(30 5% 60%)",
      ...
      <div style={S.wrap}>
        ...
        <div style={S.callout}>
          ...
          <div style={S.calloutInner}>
            ...
            <a
              ...
              style={{
                ...S.calloutLink,
                color: hoverCalloutLink ? "hsl(140 30% 35%)" : "hsl(140 30% 45%)",
              }}
          ...
          <div style={S.card}>
            <div style={S.includeRow}>
              ...
              <div style={S.includeText}>
                <strong style={{ color: "hsl(30 10% 15%)" }}>Client's name and contact details</strong> — or yours, if you're referring yourself.
              </div>
            </div>
            <div style={S.includeRow}>
              <div style={S.includeDot} />
              <div style={S.includeText}>
                <strong style={{ color: "hsl(30 10% 15%)" }}>What service you're enquiring about</strong> — NDIS Access Request Support, Functional Capacity Assessment, or Occupational Therapy.
              </div>
            </div>
            <div style={S.includeRow}>
              <div style={S.includeDot} />
              <div style={S.includeText}>
                <strong style={{ color: "hsl(30 10% 15%)" }}>Funding type</strong> — Private, self-managed NDIS, or plan-managed NDIS.
              </div>
            </div>
            <div style={S.includeRow}>
              <div style={S.includeDot} />
              <div style={S.includeText}>
                <strong style={{ color: "hsl(30 10% 15%)" }}>A brief description of the client's needs</strong> — even a few sentences helps us prepare.
              </div>
            </div>
        ...
        <div style={S.cta}>
          ...
          <a
            ...
            style={{
              ...S.ctaBtn,
              background: hoverCtaBtn ? "hsl(24 85% 50%)" : "hsl(24 85% 50%)",
              boxShadow: hoverCtaBtn
                ? "0 0 40px hsl(24 85% 50% / 0.5)"
                : "0 0 20px hsl(24 85% 50% / 0.2)",
            }}
